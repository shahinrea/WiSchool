...
const BannerSec1 = () => {
  return (
    <div className="max-w-7xl h-[605px] bg-gradient-to-r from-[#ecf2ef] mx-auto  flex flex-col md:flex-row justify-between p-10 items-center mt-6">
      <div className="flex flex-col items-start w-full md:w-6/12">
        <h1 className="font-poppins text-2xl md:text-6xl font-semibold text-left">
      ...
      <div className="flex w-full md:w-6/12 overflow-hidden ">
        <img
          src={image}
          alt=""
